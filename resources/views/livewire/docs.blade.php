<div class="container">
    <div class="page-inner" x-data="{ formupload: false }">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            <div>
                ...
                <span class="badge text-bg-primary">
                    All : {{ $docs_count }} File | Size {{ round($all_size / 1024, 2) }} MB dari Total Disk 5 GB</span>
            </div>
            <div class="ms-md-auto py-2 py-md-0">
                <a wire:navigate href="{{ route('perusahaan') }}" class="btn btn-label-info btn-round me-2">Kelola Perusahaan</a>
                <button {{ round($all_size / 1024) > 5000 ? 'disabled' : '' }} x-on:click="formupload = !formupload" class="btn btn-primary btn-round" type="button">
                    ...
                    <div class="card-body">
                        <form wire:submit.prevent="uploadfile()" x-data="{ jenisunggahan: '0' }">
                            ...
                            <div class="mb-2">
                                ...
                                <div wire:ignore>
                                    <select wire:model="company_id" id="perusahaan" class="form-select @error('company_id') is-invalid @enderror" style="width: 100% !important;" required>
                                        <option value="">=== Pilih Perusahaan ===</option>
                                        @foreach ($companies_lst as $company)
        ...
        <div class="row">
            <div class="col-12">
                @if (round($all_size / 1024) > 4000)
                    <div class="text-bg-warning text-center p-3 mb-2 rounded">
                        PERHATIAN!! Penyimpanan Hampir Penuh, Silahkan Upgrade atau Gunakan Link Google Drive <br>
                        <small>Penyimpanan Terpakai : {{ round($all_size / 1024) }} MB</small><br>
                        Anda Tidak Bisa Mengunggah File saat Penyimpanan Penuh
                    </div>
                @endif
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div class="mt-2">
                                                    ...
                                                    <span class="badge text-bg-warning ps-2">{{ $doc->type }} | {{ $doc->size }} KB
                                                    </span> <br>
